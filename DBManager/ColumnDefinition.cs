...
namespace DbManager
{
    public class ColumnDefinition
    {
        ...
        public string AsText()
        {
            ...
            return Type.ToString() + Delimiter + Encode(Name);
        ...
        public static ColumnDefinition Parse(string value)
        {
            ...
            int posDel = value.IndexOf(Delimiter);
            //buscar tipo: Tipo-Delimiter-Nombre
            //delante de el delimitador
            string tipo = value.Substring(0, posDel);

            //buscar nombre
            //el delimitador puede ser de 1 o 2 "valores", - o ->
            string nom = Decode(value.Substring(posDel + Delimiter.Length));

            //convertimos a enum
            DataType type = (DataType)Enum.Parse(typeof(DataType), tipo);

            return new ColumnDefinition(type, nom);
